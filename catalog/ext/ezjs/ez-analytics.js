 ...
 *
 * @license see ez-analytics-LICENSE.txt
 */
...
/*</DEBUG>*/
                ...
                setHomeView: function () {
                	customVariablesPage[1] = ['type', 'home'];                	
                },
                
                setCategoryView: function (cat) {
                	customVariablesPage[1] = ['type', 'category'];

                	if (isDefined(cat) && cat!=null && cat.length) {
                		if (cat instanceof Array) 
                			customVariablesPage[5] = ['cat', cat.join("|")];
                		else customVariablesPage[5] = ['cat', cat];
                	}
                },
                 ...
                 */
                setProductView: function (pid, pname, cat, color, size, brand, price, sprice) {
                	customVariablesPage[1] = ['type', 'product'];
                	
                	if (isDefined(pid) && pid!=null) 
                		customVariablesPage[2] = ['pid', pid];
                	else return;
                	
                	if (isDefined(pname) && pname!=null && pname.length) 
                		customVariablesPage[3] = ['pname', pname];
                	...
                	if (isDefined(color) && color!=null && color.length) 
                		customVariablesPage[6] = ['color', color];

                	if (isDefined(size) && size!=null) 
                		customVariablesPage[7] = ['size', size];

                	if (isDefined(brand) && brand!=null && brand.length) 
                		customVariablesPage[8] = ['brand', brand];

                	if (isDefined(price) && price!=null) 
                		customVariablesPage[9] = ['price', price];

                	if (isDefined(sprice) && sprice!=null) 
                		customVariablesPage[10] = ['sprice', sprice];

                },
                
                setAddToBasket: function (pid, pname, cat, color, size, brand, price, sprice) {
                	customVariablesPage[1] = ['type', 'addbasket'];
                ...
                setViewBasket: function (pid, total) {
                	customVariablesPage[1] = ['type', 'viewbasket'];
                	
                	if (isDefined(pid) && pid!=null) {
                		if (pid instanceof Array) 
                			customVariablesPage[2] = ['pid', pid.join("|")];
                		else customVariablesPage[2] = ['pid', pid];
                	} else return;
                	
                	if (isDefined(total) && total!=null) 
                		customVariablesPage[12] = ['total', total];
                },
                
                setOrder: function (pid, total, quantity) {
                	customVariablesPage[1] = ['type', 'order'];
                	...
                	if (isDefined(quantity) && quantity!=null) {
                		if (quantity instanceof Array) 
                			customVariablesPage[13] = ['quantity', quantity.join("|")];
                		else customVariablesPage[13] = ['quantity', quantity];
                	}
                },

                setOrderConf: function (pid, total, quantity, subtotal, tax, shipping, discount) {
                	customVariablesPage[1] = ['type', 'order_conf'];
                	...
                	if (isDefined(subtotal) && subtotal!=null) 
                		 customVariablesPage[22] = ['subtotal', subtotal];
                	
                	if (isDefined(tax) && tax!=null) 
                		customVariablesPage[23] = ['tax', tax];

                	if (isDefined(shipping) && shipping!=null) 
                		customVariablesPage[24] = ['shipping', shipping];
                	
                	if (isDefined(discount) && discount!=null) 
                		customVariablesPage[25] = ['discount', discount];
                	
                },
                
                trackRecoClick: function (pid) {
                	customVariablesPage[1] = ['type', 'reco'];
                	
                	if (isDefined(pid) && pid!=null) {
                		customVariablesPage[110] = ['rclicked', pid];
                	} else return;
        ...
        /************************************************************
         * Proxy object
         * - this allows the caller to continue push()'ing to _ezaq
        ...
        for (i = 0; i < _ezaq.length; i++) {
            if (_ezaq[i][0] === 'setTrackerUrl'
                    || _ezaq[i][0] === 'setSiteId') {
                apply(_ezaq[i]);
                delete _ezaq[i];
            }
