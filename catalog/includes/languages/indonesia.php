...
define('HEADER_TITLE_CART_CONTENTS', 'Belanjaan');
define('BOX_HEADING_SHOPPING_CART', 'Belanjaan');
define('BOX_SHOPPING_CART_NO_EMPTY', 'Cart kosong!');
define('BOX_SHOPPING_CART_EMPTY', ' barang');
define('ENTRY_SEND', 'mengirim');
define('NO_ITEM', 'Habis persediaannya');
define('TEXT_CURRENT_SORT_ORDER', 'Urutan saat ini');
define('IMAGE_BUTTON_SORT_ORDER', 'urutan');
define('ENTRY_NAME_ERROR', 'Nama Anda harus berisi minimal ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' characters.');
define('ENTRY_SECURIMAGECODE', 'Untuk mencegah spam, <br /> silahkan masukkan: 2 +2');
define('ENTRY_SECURIMAGECODE_ERROR', 'Salah: 2 +2 =?');
...
define('TEXT_PASSWORD_FORGOTTEN', 'Password Lupa Password? Klik di sini.');
