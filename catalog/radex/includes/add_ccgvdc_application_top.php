<?php
// these are CCGV specific functions, defines etc and can be moved to the respective pages
// the same applies to the add_ccgvdc_application_top.php in the catalog/includes

// this can be moved to filenames.php if you want
...
// this can be moved to databse_tables.php if you want
...
// can be added to application_top.php
define('SECURITY_CODE_LENGTH', '12');

//// the functions can be added to includes/functions/general.php
...
//// TODO: CHANGE THIS TO JQUERY DATE SELECTOR
